...
class ConfigManager:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        default_config = {
            ...
            'default_system_message': 'You are helpful personal assistant. While responding use only information from received context. If there is no clear answer from the context give user information about Failure',
